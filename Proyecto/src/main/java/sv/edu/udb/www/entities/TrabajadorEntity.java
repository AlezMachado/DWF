...
@NamedQueries({
        @NamedQuery(name = "TrabajadorEntity.findAll", query = "SELECT e FROM TrabajadorEntity e "),
        @NamedQuery(name = "TrabajadorEntity.findById", query = "SELECT e FROM TrabajadorEntity e WHERE e.idpersona = :Idpersona")})
